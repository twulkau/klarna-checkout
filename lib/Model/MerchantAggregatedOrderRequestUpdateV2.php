...
/**
 * MerchantAggregatedOrderRequestUpdateV2 Class Doc Comment
 *
 * @category Class
 * @package  Klarna
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MerchantAggregatedOrderRequestUpdateV2 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MerchantAggregatedOrderRequestUpdateV2';
    ...
    public function setTermsUri($terms_uri)
    {
        if (!is_null($terms_uri) && (mb_strlen($terms_uri) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $terms_uri when calling MerchantAggregatedOrderRequestUpdateV2., must be smaller than or equal to 2000.');
        }
        if (!is_null($terms_uri) && (mb_strlen($terms_uri) < 0)) {
            throw new \InvalidArgumentException('invalid length for $terms_uri when calling MerchantAggregatedOrderRequestUpdateV2., must be bigger than or equal to 0.');
        }
    ...
    public function setCheckoutUri($checkout_uri)
    {
        if (!is_null($checkout_uri) && (mb_strlen($checkout_uri) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $checkout_uri when calling MerchantAggregatedOrderRequestUpdateV2., must be smaller than or equal to 2000.');
        }
        if (!is_null($checkout_uri) && (mb_strlen($checkout_uri) < 0)) {
            throw new \InvalidArgumentException('invalid length for $checkout_uri when calling MerchantAggregatedOrderRequestUpdateV2., must be bigger than or equal to 0.');
        }
    ...
    public function setConfirmationUri($confirmation_uri)
    {
        if (!is_null($confirmation_uri) && (mb_strlen($confirmation_uri) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $confirmation_uri when calling MerchantAggregatedOrderRequestUpdateV2., must be smaller than or equal to 2000.');
        }
        if (!is_null($confirmation_uri) && (mb_strlen($confirmation_uri) < 0)) {
            throw new \InvalidArgumentException('invalid length for $confirmation_uri when calling MerchantAggregatedOrderRequestUpdateV2., must be bigger than or equal to 0.');
        }
    ...
    public function setPushUri($push_uri)
    {
        if (!is_null($push_uri) && (mb_strlen($push_uri) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $push_uri when calling MerchantAggregatedOrderRequestUpdateV2., must be smaller than or equal to 2000.');
        }
        if (!is_null($push_uri) && (mb_strlen($push_uri) < 0)) {
            throw new \InvalidArgumentException('invalid length for $push_uri when calling MerchantAggregatedOrderRequestUpdateV2., must be bigger than or equal to 0.');
        }
    ...
    public function setValidationUri($validation_uri)
    {
        if (!is_null($validation_uri) && (mb_strlen($validation_uri) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $validation_uri when calling MerchantAggregatedOrderRequestUpdateV2., must be smaller than or equal to 2000.');
        }
        if (!is_null($validation_uri) && (mb_strlen($validation_uri) < 0)) {
            throw new \InvalidArgumentException('invalid length for $validation_uri when calling MerchantAggregatedOrderRequestUpdateV2., must be bigger than or equal to 0.');
        }
    ...
    public function setBackToStoreUri($back_to_store_uri)
    {
        if (!is_null($back_to_store_uri) && (mb_strlen($back_to_store_uri) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $back_to_store_uri when calling MerchantAggregatedOrderRequestUpdateV2., must be smaller than or equal to 2000.');
        }
        if (!is_null($back_to_store_uri) && (mb_strlen($back_to_store_uri) < 0)) {
            throw new \InvalidArgumentException('invalid length for $back_to_store_uri when calling MerchantAggregatedOrderRequestUpdateV2., must be bigger than or equal to 0.');
        }
    ...
    public function setCancellationTermsUri($cancellation_terms_uri)
    {
        if (!is_null($cancellation_terms_uri) && (mb_strlen($cancellation_terms_uri) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $cancellation_terms_uri when calling MerchantAggregatedOrderRequestUpdateV2., must be smaller than or equal to 2000.');
        }
        if (!is_null($cancellation_terms_uri) && (mb_strlen($cancellation_terms_uri) < 0)) {
            throw new \InvalidArgumentException('invalid length for $cancellation_terms_uri when calling MerchantAggregatedOrderRequestUpdateV2., must be bigger than or equal to 0.');
        }
