...
class Options implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['acquiring_channel']) && !preg_match("/(?i)ECOMMERCE|MOTO|IN_STORE|TELESALES/", $this->container['acquiring_channel'])) {
            $invalidProperties[] = "invalid value for 'acquiring_channel', must be conform to the pattern /(?i)ECOMMERCE|MOTO|IN_STORE|TELESALES/.";
        }
    ...
    public function setAcquiringChannel($acquiring_channel)
    {
        ...
        if (!is_null($acquiring_channel) && (!preg_match("/(?i)ECOMMERCE|MOTO|IN_STORE|TELESALES/", $acquiring_channel))) {
            throw new \InvalidArgumentException("invalid value for $acquiring_channel when calling Options., must conform to the pattern /(?i)ECOMMERCE|MOTO|IN_STORE|TELESALES/.");
        }
     ...
     *
     * @param bool $national_identification_number_mandatory Additional merchant defined field. e.g. for purchases that MUST have a national insurance number.
     *
     * @return $this
     */
