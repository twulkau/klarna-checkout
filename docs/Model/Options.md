...
**additional_checkbox** | [**\Klarna\Checkout\Model\Checkbox**](Checkbox.md) | Additional merchant defined checkbox. e.g. for Newsletter opt-in. | [optional] 
**national_identification_number_mandatory** | **bool** | Additional merchant defined field. e.g. for purchases that MUST have a national insurance number. | [optional] [default to false]
...
**additional_checkboxes** | [**\Klarna\Checkout\Model\CheckboxV2[]**](CheckboxV2.md) | Additional merchant defined checkboxes. e.g. for Newsletter opt-in. | [optional] 
